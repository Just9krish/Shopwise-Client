    ...
    <div className="p-8 w-full space-y-12">
        ...
        <div className="w-full flex flex-col md:flex-row gap-4 md:gap-8 items-center justify-between">
          <div className="w-full bg-white shadow rounded px-2 py-3 flex gap-4">
            <div className="my-auto">
              <AiOutlineMoneyCollect size={60} fill="#00BFA5" className="mr-2" />
            </div>
            <div className="space-y-3">
              <div>
                <h4 className={`${style.productTitle} leading-5 !text-lg !m-0`}>Account Balance</h4>
          ...
          <div className="w-full bg-white shadow rounded px-2 py-3 flex gap-4">
            ...
            <div className="space-y-3">
              <div>
                <h4 className={`${style.productTitle} leading-5 !text-lg !m-0`}>All Orders</h4>
              </div>
              <div>
          ...
          <div className="w-full bg-white shadow rounded px-2 py-3 flex gap-4">
            ...
            <div className="space-y-3">
              <div>
                <h4 className={`${style.productTitle} leading-5 !text-lg !m-0`}>All Products</h4>
              </div>
              <div>
      ...
      <div className="space-y-4">
        ...
        <div className="w-full bg-white shadow px-2 py-5 rounded">
          <DataGrid columns={columns} rows={row} autoHeight disableRowSelectionOnClick />
        </div>
      </div>
    </div>
  );
