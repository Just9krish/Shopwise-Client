...
export const selectEventLoading = (state: RootState) => state.eventState.isEventsLoading;
export const selectEventError = (state: RootState) => state.eventState.eventError;
export const selectEventMessage = (state: RootState) => state.eventState.eventMessage;
export const selectShopEvents = (state: RootState) => state.eventState.shopEvents;
